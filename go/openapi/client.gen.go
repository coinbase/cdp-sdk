...
// UpdateSolanaAccountPolicyJSONBody defines parameters for UpdateSolanaAccountPolicy.
type UpdateSolanaAccountPolicyJSONBody struct {
	// AccountPolicy The ID of the account-level policy to apply to the account, or an empty string to unset attached policy.
	AccountPolicy *string `json:"accountPolicy,omitempty"`
}

// UpdateSolanaAccountPolicyParams defines parameters for UpdateSolanaAccountPolicy.
type UpdateSolanaAccountPolicyParams struct {
	// XIdempotencyKey An optional [UUID v4](https://www.uuidgenerator.net/version4) request header for making requests safely retryable.
	// When included, duplicate requests with the same key will return identical responses.
	// Refer to our [Idempotency docs](https://docs.cdp.coinbase.com/api-v2/docs/idempotency) for more information on using idempotency keys.
	XIdempotencyKey *IdempotencyKey `json:"X-Idempotency-Key,omitempty"`
...
// UpdateSolanaAccountPolicyJSONRequestBody defines body for UpdateSolanaAccountPolicy for application/json ContentType.
type UpdateSolanaAccountPolicyJSONRequestBody UpdateSolanaAccountPolicyJSONBody
...
type ClientInterface interface {
	...
	// UpdateSolanaAccountPolicyWithBody request with any body
	UpdateSolanaAccountPolicyWithBody(ctx context.Context, address string, params *UpdateSolanaAccountPolicyParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	UpdateSolanaAccountPolicy(ctx context.Context, address string, params *UpdateSolanaAccountPolicyParams, body UpdateSolanaAccountPolicyJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *CDPClient) UpdateSolanaAccountPolicyWithBody(ctx context.Context, address string, params *UpdateSolanaAccountPolicyParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdateSolanaAccountPolicyRequestWithBody(c.Server, address, params, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *CDPClient) UpdateSolanaAccountPolicy(ctx context.Context, address string, params *UpdateSolanaAccountPolicyParams, body UpdateSolanaAccountPolicyJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdateSolanaAccountPolicyRequest(c.Server, address, params, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewUpdateSolanaAccountPolicyRequest calls the generic UpdateSolanaAccountPolicy builder with application/json body
func NewUpdateSolanaAccountPolicyRequest(server string, address string, params *UpdateSolanaAccountPolicyParams, body UpdateSolanaAccountPolicyJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewUpdateSolanaAccountPolicyRequestWithBody(server, address, params, "application/json", bodyReader)
}

// NewUpdateSolanaAccountPolicyRequestWithBody generates requests for UpdateSolanaAccountPolicy with any type of body
func NewUpdateSolanaAccountPolicyRequestWithBody(server string, address string, params *UpdateSolanaAccountPolicyParams, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v2/solana/accounts/%s/policy", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// UpdateSolanaAccountPolicyWithBodyWithResponse request with any body
	UpdateSolanaAccountPolicyWithBodyWithResponse(ctx context.Context, address string, params *UpdateSolanaAccountPolicyParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateSolanaAccountPolicyResponse, error)

	UpdateSolanaAccountPolicyWithResponse(ctx context.Context, address string, params *UpdateSolanaAccountPolicyParams, body UpdateSolanaAccountPolicyJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateSolanaAccountPolicyResponse, error)
...
type UpdateSolanaAccountPolicyResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *SolanaAccount
	JSON400      *Error
...
// Status returns HTTPResponse.Status
func (r UpdateSolanaAccountPolicyResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r UpdateSolanaAccountPolicyResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// UpdateSolanaAccountPolicyWithBodyWithResponse request with arbitrary body returning *UpdateSolanaAccountPolicyResponse
func (c *ClientWithResponses) UpdateSolanaAccountPolicyWithBodyWithResponse(ctx context.Context, address string, params *UpdateSolanaAccountPolicyParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateSolanaAccountPolicyResponse, error) {
	rsp, err := c.UpdateSolanaAccountPolicyWithBody(ctx, address, params, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUpdateSolanaAccountPolicyResponse(rsp)
}

func (c *ClientWithResponses) UpdateSolanaAccountPolicyWithResponse(ctx context.Context, address string, params *UpdateSolanaAccountPolicyParams, body UpdateSolanaAccountPolicyJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateSolanaAccountPolicyResponse, error) {
	rsp, err := c.UpdateSolanaAccountPolicy(ctx, address, params, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseUpdateSolanaAccountPolicyResponse(rsp)
...
// ParseUpdateSolanaAccountPolicyResponse parses an HTTP response from a UpdateSolanaAccountPolicyWithResponse call
func ParseUpdateSolanaAccountPolicyResponse(rsp *http.Response) (*UpdateSolanaAccountPolicyResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &UpdateSolanaAccountPolicyResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
