...
Usage: python get_delegation_for_address.py <USER_UUID> <ADDRESS>
"""
...
async def main(user_id: str, address: str) -> None:
    ...
    async with CdpClient() as cdp:
        ...
        delegation2 = await end_user.get_delegation_for_address(address=address)
        print(f"Delegation via account method: {delegation2}")


if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python get_delegation_for_address.py <USER_UUID> <ADDRESS>")
        sys.exit(1)
