// pnpm tsx test.viem.sendSwapTransaction.ts
...
const cdp = new CdpClient({
  apiKeyId: "88d34774-705b-43f1-bcdf-5bb2490b43c0",
  apiKeySecret: "QGL5LVqnKwXAKyXKOVARfhcjft/6Nw1YgrBtrJRfKYFl6SQH6nyekydMYAaixDlFU5YcyD1Au10yA+tUm74Vqg==",
  walletSecret: "MIGHAgEAMBMGByqGSM49AgEGCCqGSM49AwEHBG0wawIBAQQgoVx9XEm7hd5rFR7F2dhxOg66GojSRLUiYZ3035rs1V6hRANCAATS5ZJ+1dFgwDQDj+NW5AMKdLCwp+7PKfUFveIhQ/viVuVyjThoTLj0hLD1IJA3LS7c1hSyA03ppAZJ+EftrAG/",
...
async function main() {
  ...
  const privateKey = `0xd54683687a033a3db32d138a8e379e88a1136c14ac1cf6efccc68f4989852bac`;
  ...
  try {
    ...
    const sellAmount = parseUnits("0.5", sellToken.decimals); // 0.1 WETH
