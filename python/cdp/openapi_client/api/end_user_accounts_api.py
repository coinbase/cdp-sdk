...
class EndUserAccountsApi:
    ...
    async def get_end_user_by_email(
        ...
        _param = self._get_end_user_by_email_serialize(
            email=email,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def get_end_user_by_email_with_http_info(
        self,
        email: Annotated[StrictStr, Field(description="The email address to search for across all authentication methods.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_end_user_by_email_without_preload_content(
        self,
        email: Annotated[StrictStr, Field(description="The email address to search for across all authentication methods.")],
        _request_timeout: Union[
            None,
    ...
    def _get_end_user_by_email_serialize(
        self,
        email,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/end-users/by-email/{email}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
