...
class EVMAccountsApi:
    ...
    async def get_evm_eip7702_delegation_operation_status(
        self,
        delegation_operation_id: Annotated[str, Field(strict=True, description="The unique identifier of the delegation operation.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Returns the status of an EIP-7702 delegation operation. Use the delegationOperationId returned by the Create EIP-7702 delegation endpoint to poll for operation completion.

        :param delegation_operation_id: The unique identifier of the delegation operation. (required)
        ...
        _param = self._get_evm_eip7702_delegation_operation_status_serialize(
    ...
    @validate_call
    async def get_evm_eip7702_delegation_operation_status_with_http_info(
        self,
        delegation_operation_id: Annotated[str, Field(strict=True, description="The unique identifier of the delegation operation.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_evm_eip7702_delegation_operation_status_without_preload_content(
        self,
        delegation_operation_id: Annotated[str, Field(strict=True, description="The unique identifier of the delegation operation.")],
        _request_timeout: Union[
            None,
    ...
    def _get_evm_eip7702_delegation_operation_status_serialize(
        self,
