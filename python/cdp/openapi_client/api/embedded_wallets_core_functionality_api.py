...
class EmbeddedWalletsCoreFunctionalityApi:
    ...
    def _create_evm_eip7702_delegation_with_end_user_account_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/embedded-wallet-api/projects/{projectId}/end-users/{userId}/evm/eip7702/delegation',
    ...
    def _revoke_delegation_for_end_user_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v2/embedded-wallet-api/projects/{projectId}/end-users/{userId}/delegation',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def revoke_spend_permission_with_end_user_account(
        self,
        project_id: Annotated[str, Field(strict=True, description="The ID of the CDP Project.")],
        user_id: Annotated[str, Field(strict=True, description="The ID of the end user.")],
        ...
        _param = self._revoke_spend_permission_with_end_user_account_serialize(
            project_id=project_id,
            user_id=user_id,
            address=address,
    ...
    @validate_call
    async def revoke_spend_permission_with_end_user_account_with_http_info(
        self,
        project_id: Annotated[str, Field(strict=True, description="The ID of the CDP Project.")],
        user_id: Annotated[str, Field(strict=True, description="The ID of the end user.")],
        address: Annotated[str, Field(strict=True, description="The address of the Smart account this spend permission is valid for.")],
    ...
    @validate_call
    async def revoke_spend_permission_with_end_user_account_without_preload_content(
        self,
        project_id: Annotated[str, Field(strict=True, description="The ID of the CDP Project.")],
        user_id: Annotated[str, Field(strict=True, description="The ID of the end user.")],
        address: Annotated[str, Field(strict=True, description="The address of the Smart account this spend permission is valid for.")],
    ...
    def _revoke_spend_permission_with_end_user_account_serialize(
        self,
        project_id,
        user_id,
        address,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/embedded-wallet-api/projects/{projectId}/end-users/{userId}/evm/smart-accounts/{address}/spend-permissions/revoke',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _send_evm_asset_with_end_user_account_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/embedded-wallet-api/projects/{projectId}/end-users/{userId}/evm/{address}/send/{asset}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def send_solana_asset_with_end_user_account(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SendSolanaAssetWithEndUserAccount200Response",
            '400': "Error",
            '401': "Error",
            '402': "Error",
            '404': "Error",
    ...
    async def send_solana_asset_with_end_user_account_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SendSolanaAssetWithEndUserAccount200Response]:
        """Send USDC on Solana
    ...
    def _send_solana_asset_with_end_user_account_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/embedded-wallet-api/projects/{projectId}/end-users/{userId}/solana/{address}/send/{asset}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _send_solana_transaction_with_end_user_account_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/embedded-wallet-api/projects/{projectId}/end-users/{userId}/solana/send/transaction',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _send_user_operation_with_end_user_account_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/embedded-wallet-api/projects/{projectId}/end-users/{userId}/evm/smart-accounts/{address}/send',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def sign_solana_hash_with_end_user_account(
        self,
        project_id: Annotated[str, Field(strict=True, description="The ID of the CDP Project.")],
        user_id: Annotated[str, Field(strict=True, description="The ID of the end user.")],
        x_wallet_auth: Annotated[Optional[StrictStr], Field(description="A JWT signed using your Wallet Secret, encoded in base64. Refer to the [Generate Wallet Token](https://docs.cdp.coinbase.com/api-reference/v2/authentication#2-generate-wallet-token) section of our Authentication docs for more details on how to generate your Wallet Token. ")] = None,
        x_idempotency_key: Annotated[Optional[Annotated[str, Field(min_length=1, strict=True, max_length=128)]], Field(description="An optional string request header for making requests safely retryable. When included, duplicate requests with the same key will return identical responses. Refer to our [Idempotency docs](https://docs.cdp.coinbase.com/api-reference/v2/idempotency) for more information on using idempotency keys. ")] = None,
        x_developer_auth: Annotated[Optional[StrictStr], Field(description="A JWT signed using your Wallet Secret, encoded in base64. Refer to the [Generate Wallet Token](https://docs.cdp.coinbase.com/api-reference/v2/authentication#2-generate-wallet-token) section of our Authentication docs for more details on how to generate your Wallet Token. ")] = None,
        sign_solana_hash_with_end_user_account_request: Optional[SignSolanaHashWithEndUserAccountRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param x_developer_auth: A JWT signed using your Wallet Secret, encoded in base64. Refer to the [Generate Wallet Token](https://docs.cdp.coinbase.com/api-reference/v2/authentication#2-generate-wallet-token) section of our Authentication docs for more details on how to generate your Wallet Token. 
        :type x_developer_auth: str
        :param sign_solana_hash_with_end_user_account_request:
        :type sign_solana_hash_with_end_user_account_request: SignSolanaHashWithEndUserAccountRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._sign_solana_hash_with_end_user_account_serialize(
            project_id=project_id,
            user_id=user_id,
            x_wallet_auth=x_wallet_auth,
            x_idempotency_key=x_idempotency_key,
            x_developer_auth=x_developer_auth,
            sign_solana_hash_with_end_user_account_request=sign_solana_hash_with_end_user_account_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SignSolanaHashWithEndUserAccount200Response",
            '400': "Error",
            '401': "Error",
            '402': "Error",
            '404': "Error",
    ...
    @validate_call
    async def sign_solana_hash_with_end_user_account_with_http_info(
        self,
        project_id: Annotated[str, Field(strict=True, description="The ID of the CDP Project.")],
        user_id: Annotated[str, Field(strict=True, description="The ID of the end user.")],
        x_wallet_auth: Annotated[Optional[StrictStr], Field(description="A JWT signed using your Wallet Secret, encoded in base64. Refer to the [Generate Wallet Token](https://docs.cdp.coinbase.com/api-reference/v2/authentication#2-generate-wallet-token) section of our Authentication docs for more details on how to generate your Wallet Token. ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SignSolanaHashWithEndUserAccount200Response]:
        """Sign a hash with end user Solana account
    ...
    @validate_call
    async def sign_solana_hash_with_end_user_account_without_preload_content(
        self,
        project_id: Annotated[str, Field(strict=True, description="The ID of the CDP Project.")],
        user_id: Annotated[str, Field(strict=True, description="The ID of the end user.")],
        x_wallet_auth: Annotated[Optional[StrictStr], Field(description="A JWT signed using your Wallet Secret, encoded in base64. Refer to the [Generate Wallet Token](https://docs.cdp.coinbase.com/api-reference/v2/authentication#2-generate-wallet-token) section of our Authentication docs for more details on how to generate your Wallet Token. ")] = None,
    ...
    def _sign_solana_hash_with_end_user_account_serialize(
        self,
        project_id,
        user_id,
        x_wallet_auth,
        x_idempotency_key,
        x_developer_auth,
        sign_solana_hash_with_end_user_account_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if sign_solana_hash_with_end_user_account_request is not None:
            _body_params = sign_solana_hash_with_end_user_account_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/embedded-wallet-api/projects/{projectId}/end-users/{userId}/solana/sign',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _sign_solana_message_with_end_user_account_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/embedded-wallet-api/projects/{projectId}/end-users/{userId}/solana/sign/message',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
