...
class EndUserAccountManagementApi:
    ...
    async def lookup_end_user(
        self,
        email: Annotated[Optional[Annotated[str, Field(strict=True, max_length=254)]], Field(description="The email address to search for across all email-based authentication methods.")] = None,
