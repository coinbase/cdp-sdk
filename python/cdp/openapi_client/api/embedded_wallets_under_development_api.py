...
from cdp.openapi_client.models.initiate_authentication_response_wrapper import InitiateAuthenticationResponseWrapper
...
class EmbeddedWalletsUnderDevelopmentApi:
    ...
    async def initiate_authentication(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> InitiateAuthenticationResponseWrapper:
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "InitiateAuthenticationResponseWrapper",
            '400': "Error",
            '500': "Error",
        }
        response_data = await self.api_client.call_api(
    ...
    async def initiate_authentication_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[InitiateAuthenticationResponseWrapper]:
        """Initiate end user authentication
