...
class TestSendEndUserOperationRule(unittest.TestCase):
    """SendEndUserOperationRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendEndUserOperationRule:
        """Test SendEndUserOperationRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendEndUserOperationRule`
        """
        model = SendEndUserOperationRule()
        if include_optional:
            return SendEndUserOperationRule(
                action = 'accept',
    ...
    def testSendEndUserOperationRule(self):
        """Test SendEndUserOperationRule"""
