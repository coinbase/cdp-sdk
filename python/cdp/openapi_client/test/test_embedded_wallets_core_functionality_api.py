...
class TestEmbeddedWalletsCoreFunctionalityApi(unittest.IsolatedAsyncioTestCase):
    """EmbeddedWalletsCoreFunctionalityApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = EmbeddedWalletsCoreFunctionalityApi()
    ...
    async def test_revoke_spend_permission_with_end_user_account(self) -> None:
        """Test case for revoke_spend_permission_with_end_user_account
    ...
    async def test_sign_solana_hash_with_end_user_account(self) -> None:
        """Test case for sign_solana_hash_with_end_user_account
