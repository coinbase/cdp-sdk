...
class TestCreateSwapResponse(unittest.TestCase):
    """CreateSwapResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateSwapResponse:
        """Test CreateSwapResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateSwapResponse`
        """
        model = CreateSwapResponse()
        if include_optional:
    ...
    def testCreateSwapResponse(self):
        """Test CreateSwapResponse"""
