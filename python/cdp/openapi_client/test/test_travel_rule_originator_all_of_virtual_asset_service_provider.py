...
class TestTravelRuleOriginatorAllOfVirtualAssetServiceProvider(unittest.TestCase):
    """TravelRuleOriginatorAllOfVirtualAssetServiceProvider unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TravelRuleOriginatorAllOfVirtualAssetServiceProvider:
        ...
        # uncomment below to create an instance of `TravelRuleOriginatorAllOfVirtualAssetServiceProvider`
        """
    ...
    def testTravelRuleOriginatorAllOfVirtualAssetServiceProvider(self):
        """Test TravelRuleOriginatorAllOfVirtualAssetServiceProvider"""
