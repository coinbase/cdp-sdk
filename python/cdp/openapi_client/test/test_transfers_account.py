...
class TestTransfersAccount(unittest.TestCase):
    """TransfersAccount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransfersAccount:
        ...
        # uncomment below to create an instance of `TransfersAccount`
        """
