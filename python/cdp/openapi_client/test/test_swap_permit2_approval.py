...
class TestSwapPermit2Approval(unittest.TestCase):
    """SwapPermit2Approval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SwapPermit2Approval:
        """Test SwapPermit2Approval
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SwapPermit2Approval`
        """
        model = SwapPermit2Approval()
        if include_optional:
            return SwapPermit2Approval(
    ...
    def testSwapPermit2Approval(self):
        """Test SwapPermit2Approval"""
