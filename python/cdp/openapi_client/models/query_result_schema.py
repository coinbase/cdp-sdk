...
class QueryResultSchema(BaseModel):
    ...
    """ # noqa: E501
    columns: Optional[List[QueryResultSchemaColumnsInner]] = Field(default=None, description="Column definitions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "columns": [QueryResultSchemaColumnsInner.from_dict(_item) for _item in obj["columns"]] if obj.get("columns") is not None else None
        })
        return _obj
