...
class SignSolanaHashWithEndUserAccountRequest(BaseModel):
    """
    SignSolanaHashWithEndUserAccountRequest
    """ # noqa: E501
    hash: StrictStr = Field(description="The arbitrary 32 byte hash to sign as base58 encoded string.")
    ...
    __properties: ClassVar[List[str]] = ["hash", "address", "walletSecretId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SignSolanaHashWithEndUserAccountRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SignSolanaHashWithEndUserAccountRequest from a dict"""
        if obj is None:
            return None
