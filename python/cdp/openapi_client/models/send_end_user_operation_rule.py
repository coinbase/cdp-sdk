...
class SendEndUserOperationRule(BaseModel):
    ...
    criteria: List[SendEvmTransactionCriteriaInner] = Field(description="A schema for specifying criteria for the sendEndUserOperation operation.")
    ...
    def operation_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['sendEndUserOperation']):
            raise ValueError("must be one of enum values ('sendEndUserOperation')")
        return value
