...
class UpdateWalletSecretRequest(BaseModel):
    """
    UpdateWalletSecretRequest
    """ # noqa: E501
    public_key: StrictStr = Field(description="The base64 encoded public key of the new Wallet Secret.", alias="publicKey")
