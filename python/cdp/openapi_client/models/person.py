...
class Person(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Full legal name of the person.")
    address: Optional[PhysicalAddress] = Field(default=None, description="Physical address of the person.")
