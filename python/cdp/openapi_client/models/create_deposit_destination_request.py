...
class CreateDepositDestinationRequest(BaseModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = CreateDepositDestinationRequest.model_construct()
        error_messages = []
        match = 0
        # validate data type: CreateCryptoDepositDestinationRequest
        if not isinstance(v, CreateCryptoDepositDestinationRequest):
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into CreateCryptoDepositDestinationRequest
        try:
            instance.actual_instance = CreateCryptoDepositDestinationRequest.from_json(json_str)
            match += 1
