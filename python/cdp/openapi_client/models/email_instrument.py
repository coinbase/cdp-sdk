...
class EmailInstrument(BaseModel):
    """
    The target of the payment is an email address.
    """ # noqa: E501
    email: StrictStr = Field(description="The email address of the recipient. The recipient will need to have an account with Coinbase or onboard to Coinbase to receive the payment.")
