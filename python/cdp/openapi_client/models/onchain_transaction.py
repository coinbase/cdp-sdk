...
class OnchainTransaction(BaseModel):
    ...
    """ # noqa: E501
    transaction_hash: StrictStr = Field(description="The blockchain transaction hash.", alias="transactionHash")
    network: PaymentSourceNetwork = Field(description="The blockchain network the transaction occurred on.")
