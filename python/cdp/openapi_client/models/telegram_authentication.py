...
class TelegramAuthentication(BaseModel):
    ...
    first_name: StrictStr = Field(description="The Telegram user's first name.", alias="firstName")
    last_name: StrictStr = Field(description="The Telegram user's last name.", alias="lastName")
    photo_url: StrictStr = Field(description="The Telegram user's profile picture.", alias="photoUrl")
    auth_date: StrictInt = Field(description="The Telegram user's last login as a Unix timestamp.", alias="authDate")
    username: StrictStr = Field(description="The Telegram user's username.")
