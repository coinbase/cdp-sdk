...
class CreateSwapResponse(BaseModel):
    ...
    permit2: Optional[CreateSwapResponseAllOfPermit2]
    transaction: CreateSwapResponseAllOfTransaction
    __properties: ClassVar[List[str]] = ["blockNumber", "buyAmount", "buyToken", "fees", "issues", "liquidityAvailable", "minBuyAmount", "sellAmount", "sellToken", "permit2", "transaction"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateSwapResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateSwapResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "permit2": CreateSwapResponseAllOfPermit2.from_dict(obj["permit2"]) if obj.get("permit2") is not None else None,
            "transaction": CreateSwapResponseAllOfTransaction.from_dict(obj["transaction"]) if obj.get("transaction") is not None else None
        })
        return _obj
