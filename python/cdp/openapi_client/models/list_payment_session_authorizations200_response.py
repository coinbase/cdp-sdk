...
class ListPaymentSessionAuthorizations200Response(BaseModel):
    """
    ...
    authorizations: List[Authorization] = Field(description="The list of authorizations.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "authorizations"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListPaymentSessionAuthorizations200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListPaymentSessionAuthorizations200Response from a dict"""
        if obj is None:
            return None
