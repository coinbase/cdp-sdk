...
class DepositDestination(BaseModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = DepositDestination.model_construct()
        error_messages = []
        match = 0
        # validate data type: CryptoDepositDestination
        if not isinstance(v, CryptoDepositDestination):
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into CryptoDepositDestination
        try:
            instance.actual_instance = CryptoDepositDestination.from_json(json_str)
            match += 1
