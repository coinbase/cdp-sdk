...
class ListPaymentSessionCaptures200Response(BaseModel):
    """
    ...
    captures: List[Capture] = Field(description="The list of captures.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "captures"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListPaymentSessionCaptures200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListPaymentSessionCaptures200Response from a dict"""
        if obj is None:
            return None
