...
class ListPaymentMethods200Response(BaseModel):
    """
    ...
    payment_methods: List[PaymentMethodsPaymentMethod] = Field(description="The list of payment methods.", alias="paymentMethods")
    __properties: ClassVar[List[str]] = ["nextPageToken", "paymentMethods"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "paymentMethods": [PaymentMethodsPaymentMethod.from_dict(_item) for _item in obj["paymentMethods"]] if obj.get("paymentMethods") is not None else None
        })
        return _obj
