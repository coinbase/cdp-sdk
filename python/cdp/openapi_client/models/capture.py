...
class Capture(BaseModel):
    ...
    """ # noqa: E501
    capture_id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The unique identifier of the capture.", alias="captureId")
    payment_session_id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The ID of the payment session this capture belongs to.", alias="paymentSessionId")
    status: Optional[PaymentActionStatus] = Field(default=None, description="The current status of the capture.")
    amount: Optional[StrictStr] = Field(default=None, description="A decimal representation of the captured amount, denominated in the session's `asset`.")
