...
class CreateOnrampOrderRequest(BaseModel):
    ...
    """ # noqa: E501
    agreement_accepted_at: datetime = Field(description="The timestamp of the time the user acknowledged they are accepting the Coinbase service agreement  (https://www.coinbase.com/legal/guest-checkout/us) by using Coinbase Onramp.", alias="agreementAcceptedAt")
    ...
    email: StrictStr = Field(description="The email address of the user requesting the onramp transaction.")
    ...
    purchase_amount: Optional[StrictStr] = Field(default=None, description="A string representing the amount of fiat the user wishes to pay in exchange for crypto. When using  this parameter the returned quote will be exclusive of fees i.e. the user will receive this exact  amount of the purchase currency.", alias="purchaseAmount")
    purchase_currency: StrictStr = Field(description="The ticker (e.g. `BTC`, `USDC`) or the UUID (e.g. `d85dce9b-5b73-5c3c-8978-522ce1d1c1b4`) of crypto  asset to be purchased.  Use the [Onramp Buy Options API](https://docs.cdp.coinbase.com/api-reference/rest-api/onramp-offramp/get-buy-options) to discover the supported purchase currencies for your user's location.", alias="purchaseCurrency")
