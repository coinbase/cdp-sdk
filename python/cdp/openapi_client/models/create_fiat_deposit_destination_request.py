...
class CreateFiatDepositDestinationRequest(BaseModel):
    """
    ...
    fiat: CreateDepositDestinationFiat = Field(description="Fiat-specific details. Required when `type` is `fiat`.")
    __properties: ClassVar[List[str]] = ["accountId", "type", "target", "metadata", "compliance", "fiat"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateFiatDepositDestinationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateFiatDepositDestinationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "fiat": CreateDepositDestinationFiat.from_dict(obj["fiat"]) if obj.get("fiat") is not None else None
        })
        return _obj
