...
class Void(BaseModel):
    ...
    """ # noqa: E501
    void_id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The unique identifier of the void.", alias="voidId")
    payment_session_id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The ID of the payment session this void belongs to.", alias="paymentSessionId")
    status: Optional[PaymentActionStatus] = Field(default=None, description="The current status of the void.")
    ...
    def void_id_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^void_[a-f0-9\-]{36}$", value):
            raise ValueError(r"must validate the regular expression /^void_[a-f0-9\-]{36}$/")
        return value
