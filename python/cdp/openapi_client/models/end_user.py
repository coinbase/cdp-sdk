...
class EndUser(BaseModel):
    ...
    evm_account_objects: Optional[List[EndUserEvmAccount]] = Field(default=None, description="The list of EVM accounts associated with the end user. End users can have up to 10 EVM accounts.", alias="evmAccountObjects")
    ...
    evm_smart_account_objects: Optional[List[EndUserEvmSmartAccount]] = Field(default=None, description="The list of EVM smart accounts associated with the end user. Each EVM EOA can own one smart account.", alias="evmSmartAccountObjects")
    ...
    solana_account_objects: Optional[List[EndUserSolanaAccount]] = Field(default=None, description="The list of Solana accounts associated with the end user. End users can have up to 10 Solana accounts.", alias="solanaAccountObjects")
