...
class InitiateSmsAuthenticationResponse(BaseModel):
    """
    ...
    next_step: InitiateSmsAuthenticationNextStep = Field(alias="nextStep")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nextStep": InitiateSmsAuthenticationNextStep.from_dict(obj["nextStep"]) if obj.get("nextStep") is not None else None
        })
        return _obj
