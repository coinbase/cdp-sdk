...
class SubmitOnrampVerificationRequest(BaseModel):
    """
    Request body for submitting an OTP code to complete an onramp verification.
    """ # noqa: E501
    otp_code: Annotated[str, Field(strict=True)] = Field(description="The 6-digit OTP code the user received.", alias="otpCode")
