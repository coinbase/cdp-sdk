...
SENDENDUSERSOLASSETCRITERIAINNER_ONE_OF_SCHEMAS = ["MintAddressCriterion", "ProgramIdCriterion", "RateLimitingCriterion", "SolAddressCriterion", "SolDataCriterion", "SolNetworkCriterion", "SolValueCriterion", "SplAddressCriterion", "SplValueCriterion"]
...
class SendEndUserSolAssetCriteriaInner(BaseModel):
    ...
    oneof_schema_9_validator: Optional[RateLimitingCriterion] = None
    actual_instance: Optional[Union[MintAddressCriterion, ProgramIdCriterion, RateLimitingCriterion, SolAddressCriterion, SolDataCriterion, SolNetworkCriterion, SolValueCriterion, SplAddressCriterion, SplValueCriterion]] = None
    one_of_schemas: Set[str] = { "MintAddressCriterion", "ProgramIdCriterion", "RateLimitingCriterion", "SolAddressCriterion", "SolDataCriterion", "SolNetworkCriterion", "SolValueCriterion", "SplAddressCriterion", "SplValueCriterion" }
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], MintAddressCriterion, ProgramIdCriterion, RateLimitingCriterion, SolAddressCriterion, SolDataCriterion, SolNetworkCriterion, SolValueCriterion, SplAddressCriterion, SplValueCriterion]]:
