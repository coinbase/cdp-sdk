...
class ListPaymentSessionRefunds200Response(BaseModel):
    """
    ...
    refunds: List[Refund] = Field(description="The list of refunds.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "refunds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListPaymentSessionRefunds200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListPaymentSessionRefunds200Response from a dict"""
        if obj is None:
            return None
