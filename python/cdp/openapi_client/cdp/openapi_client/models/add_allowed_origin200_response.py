...
class AddAllowedOrigin200Response(BaseModel):
    """
    AddAllowedOrigin200Response
    """ # noqa: E501
    origin: Optional[StrictStr] = Field(default=None, description="The origin that was added to the CORS configuration.")
