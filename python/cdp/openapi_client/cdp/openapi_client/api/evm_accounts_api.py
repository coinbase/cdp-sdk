...
class EVMAccountsApi:
    ...
    @validate_call
    async def update_evm_account_policy(
        self,
        address: Annotated[str, Field(strict=True, description="The 0x-prefixed address of the EVM account. The address does not need to be checksummed.")],
        x_idempotency_key: Annotated[Optional[Annotated[str, Field(min_length=36, strict=True, max_length=36)]], Field(description="An optional [UUID v4](https://www.uuidgenerator.net/version4) request header for making requests safely retryable. When included, duplicate requests with the same key will return identical responses.  Refer to our [Idempotency docs](https://docs.cdp.coinbase.com/api-reference/v2/idempotency) for more information on using idempotency keys. ")] = None,
        update_evm_account_policy_request: Optional[UpdateEvmAccountPolicyRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param x_idempotency_key: An optional [UUID v4](https://www.uuidgenerator.net/version4) request header for making requests safely retryable. When included, duplicate requests with the same key will return identical responses.  Refer to our [Idempotency docs](https://docs.cdp.coinbase.com/api-reference/v2/idempotency) for more information on using idempotency keys. 
        :type x_idempotency_key: str
        :param update_evm_account_policy_request:
        :type update_evm_account_policy_request: UpdateEvmAccountPolicyRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_evm_account_policy_serialize(
            address=address,
            x_idempotency_key=x_idempotency_key,
            update_evm_account_policy_request=update_evm_account_policy_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def update_evm_account_policy_with_http_info(
        self,
        address: Annotated[str, Field(strict=True, description="The 0x-prefixed address of the EVM account. The address does not need to be checksummed.")],
        x_idempotency_key: Annotated[Optional[Annotated[str, Field(min_length=36, strict=True, max_length=36)]], Field(description="An optional [UUID v4](https://www.uuidgenerator.net/version4) request header for making requests safely retryable. When included, duplicate requests with the same key will return identical responses.  Refer to our [Idempotency docs](https://docs.cdp.coinbase.com/api-reference/v2/idempotency) for more information on using idempotency keys. ")] = None,
        update_evm_account_policy_request: Optional[UpdateEvmAccountPolicyRequest] = None,
    ...
    @validate_call
    async def update_evm_account_policy_without_preload_content(
        self,
        address: Annotated[str, Field(strict=True, description="The 0x-prefixed address of the EVM account. The address does not need to be checksummed.")],
        x_idempotency_key: Annotated[Optional[Annotated[str, Field(min_length=36, strict=True, max_length=36)]], Field(description="An optional [UUID v4](https://www.uuidgenerator.net/version4) request header for making requests safely retryable. When included, duplicate requests with the same key will return identical responses.  Refer to our [Idempotency docs](https://docs.cdp.coinbase.com/api-reference/v2/idempotency) for more information on using idempotency keys. ")] = None,
        update_evm_account_policy_request: Optional[UpdateEvmAccountPolicyRequest] = None,
    ...
    def _update_evm_account_policy_serialize(
        self,
        address,
        x_idempotency_key,
        update_evm_account_policy_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_evm_account_policy_request is not None:
            _body_params = update_evm_account_policy_request
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/v2/evm/accounts/{address}/policy',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def update_evm_smart_account_policy(
        self,
        address: Annotated[str, Field(strict=True, description="The 0x-prefixed address of the Smart Account. The address does not need to be checksummed.")],
        x_idempotency_key: Annotated[Optional[Annotated[str, Field(min_length=36, strict=True, max_length=36)]], Field(description="An optional [UUID v4](https://www.uuidgenerator.net/version4) request header for making requests safely retryable. When included, duplicate requests with the same key will return identical responses.  Refer to our [Idempotency docs](https://docs.cdp.coinbase.com/api-reference/v2/idempotency) for more information on using idempotency keys. ")] = None,
        update_evm_smart_account_policy_request: Optional[UpdateEvmSmartAccountPolicyRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param address: The 0x-prefixed address of the Smart Account. The address does not need to be checksummed. (required)
        :type address: str
        :param x_idempotency_key: An optional [UUID v4](https://www.uuidgenerator.net/version4) request header for making requests safely retryable. When included, duplicate requests with the same key will return identical responses.  Refer to our [Idempotency docs](https://docs.cdp.coinbase.com/api-reference/v2/idempotency) for more information on using idempotency keys. 
        :type x_idempotency_key: str
        :param update_evm_smart_account_policy_request:
        :type update_evm_smart_account_policy_request: UpdateEvmSmartAccountPolicyRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_evm_smart_account_policy_serialize(
            address=address,
            x_idempotency_key=x_idempotency_key,
            update_evm_smart_account_policy_request=update_evm_smart_account_policy_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def update_evm_smart_account_policy_with_http_info(
        self,
        address: Annotated[str, Field(strict=True, description="The 0x-prefixed address of the Smart Account. The address does not need to be checksummed.")],
        x_idempotency_key: Annotated[Optional[Annotated[str, Field(min_length=36, strict=True, max_length=36)]], Field(description="An optional [UUID v4](https://www.uuidgenerator.net/version4) request header for making requests safely retryable. When included, duplicate requests with the same key will return identical responses.  Refer to our [Idempotency docs](https://docs.cdp.coinbase.com/api-reference/v2/idempotency) for more information on using idempotency keys. ")] = None,
        update_evm_smart_account_policy_request: Optional[UpdateEvmSmartAccountPolicyRequest] = None,
    ...
    @validate_call
    async def update_evm_smart_account_policy_without_preload_content(
        self,
        address: Annotated[str, Field(strict=True, description="The 0x-prefixed address of the Smart Account. The address does not need to be checksummed.")],
        x_idempotency_key: Annotated[Optional[Annotated[str, Field(min_length=36, strict=True, max_length=36)]], Field(description="An optional [UUID v4](https://www.uuidgenerator.net/version4) request header for making requests safely retryable. When included, duplicate requests with the same key will return identical responses.  Refer to our [Idempotency docs](https://docs.cdp.coinbase.com/api-reference/v2/idempotency) for more information on using idempotency keys. ")] = None,
        update_evm_smart_account_policy_request: Optional[UpdateEvmSmartAccountPolicyRequest] = None,
    ...
    def _update_evm_smart_account_policy_serialize(
        self,
        address,
        x_idempotency_key,
        update_evm_smart_account_policy_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_evm_smart_account_policy_request is not None:
            _body_params = update_evm_smart_account_policy_request
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/v2/evm/smart-accounts/{address}/policy',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
