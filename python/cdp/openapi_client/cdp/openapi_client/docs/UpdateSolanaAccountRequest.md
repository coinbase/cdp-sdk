...
update_solana_account_request_instance = UpdateSolanaAccountRequest.from_json(json)
# print the JSON string representation of the object
print(UpdateSolanaAccountRequest.to_json())

# convert the object into a dict
update_solana_account_request_dict = update_solana_account_request_instance.to_dict()
# create an instance of UpdateSolanaAccountRequest from a dict
update_solana_account_request_from_dict = UpdateSolanaAccountRequest.from_dict(update_solana_account_request_dict)
```
