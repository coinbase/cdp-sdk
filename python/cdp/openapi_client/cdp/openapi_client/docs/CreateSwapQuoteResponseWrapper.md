...
------------ | ------------- | ------------- | -------------
**permit2** | [**CreateSwapQuoteResponseAllOfPermit2**](CreateSwapQuoteResponseAllOfPermit2.md) |  | 
**transaction** | [**CreateSwapQuoteResponseAllOfTransaction**](CreateSwapQuoteResponseAllOfTransaction.md) |  | 
...
json = "{}"
# create an instance of CreateSwapQuoteResponseWrapper from a JSON string
create_swap_quote_response_wrapper_instance = CreateSwapQuoteResponseWrapper.from_json(json)
# print the JSON string representation of the object
print(CreateSwapQuoteResponseWrapper.to_json())

# convert the object into a dict
create_swap_quote_response_wrapper_dict = create_swap_quote_response_wrapper_instance.to_dict()
# create an instance of CreateSwapQuoteResponseWrapper from a dict
create_swap_quote_response_wrapper_from_dict = CreateSwapQuoteResponseWrapper.from_dict(create_swap_quote_response_wrapper_dict)
```
