...
create_swap_quote_response_instance = CreateSwapQuoteResponse.from_json(json)
# print the JSON string representation of the object
print(CreateSwapQuoteResponse.to_json())

# convert the object into a dict
create_swap_quote_response_dict = create_swap_quote_response_instance.to_dict()
# create an instance of CreateSwapQuoteResponse from a dict
create_swap_quote_response_from_dict = CreateSwapQuoteResponse.from_dict(create_swap_quote_response_dict)
```
