...
create_evm_account_request_instance = CreateEvmAccountRequest.from_json(json)
# print the JSON string representation of the object
print(CreateEvmAccountRequest.to_json())

# convert the object into a dict
create_evm_account_request_dict = create_evm_account_request_instance.to_dict()
# create an instance of CreateEvmAccountRequest from a dict
create_evm_account_request_from_dict = CreateEvmAccountRequest.from_dict(create_evm_account_request_dict)
```
