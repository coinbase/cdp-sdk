...
evm_typed_numerical_condition_instance = EvmTypedNumericalCondition.from_json(json)
# print the JSON string representation of the object
print(EvmTypedNumericalCondition.to_json())

# convert the object into a dict
evm_typed_numerical_condition_dict = evm_typed_numerical_condition_instance.to_dict()
# create an instance of EvmTypedNumericalCondition from a dict
evm_typed_numerical_condition_from_dict = EvmTypedNumericalCondition.from_dict(evm_typed_numerical_condition_dict)
```
