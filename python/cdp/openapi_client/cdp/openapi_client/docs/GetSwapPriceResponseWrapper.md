...
json = "{}"
# create an instance of GetSwapPriceResponseWrapper from a JSON string
get_swap_price_response_wrapper_instance = GetSwapPriceResponseWrapper.from_json(json)
# print the JSON string representation of the object
print(GetSwapPriceResponseWrapper.to_json())

# convert the object into a dict
get_swap_price_response_wrapper_dict = get_swap_price_response_wrapper_instance.to_dict()
# create an instance of GetSwapPriceResponseWrapper from a dict
get_swap_price_response_wrapper_from_dict = GetSwapPriceResponseWrapper.from_dict(get_swap_price_response_wrapper_dict)
```
