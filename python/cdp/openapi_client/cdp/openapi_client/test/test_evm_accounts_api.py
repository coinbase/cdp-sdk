...
class TestEVMAccountsApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_update_evm_account_policy(self) -> None:
        """Test case for update_evm_account_policy

        Update an EVM account's policy
        """
        pass

    async def test_update_evm_smart_account_policy(self) -> None:
        """Test case for update_evm_smart_account_policy
