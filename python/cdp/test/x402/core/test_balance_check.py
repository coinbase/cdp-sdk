"""Unit tests for cdp.x402.core.balance_check."""
...
from cdp.x402.core.balance_check import (
    InsufficientFundsError,
    create_balance_check_hook,
)
from cdp.x402.core.client import CDPx402ClientConfig, create_cdp_x402_client
...
class TestBalanceCheckWiredInClient:
    ...
    async def test_hook_is_registered_by_default(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        with (
            patch("cdp.x402.core.client.CdpClient", return_value=self._make_cdp_mock()),
    ...
    async def test_rpc_urls_from_env_var(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        with (
            ...
            patch("cdp.x402.core.client.register_exact_evm_client"),
            patch("cdp.x402.core.client.x402Client", return_value=inner_mock),
            patch("cdp.x402.core.client.create_balance_check_hook", side_effect=capture_hook),
        ):
            await create_cdp_x402_client()
