...
from cdp.x402.core.guardrails.types import Amount, SpendControlError, SpendControls
...
class TestSyncClient:
    ...
    def test_sync_confirm_logs_threshold_errors_but_does_not_raise(self, caplog: Any) -> None:
        ...
        with caplog.at_level(logging.WARNING, logger="cdp.x402.core.guardrails.apply"):
