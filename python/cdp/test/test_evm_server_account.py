...
@pytest.mark.asyncio 
async def test_network_scoped_server_account_uses_base_node_rpc_for_tx_waits(server_account_model_factory):
    ...
    with patch('cdp.network_scoped_evm_server_account.get_base_node_rpc_url') as mock_get_base_node_rpc_url:
