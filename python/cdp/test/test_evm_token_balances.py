...
from cdp.openapi_client.models.supported_evm_network import SupportedEvmNetwork
...
def test_evm_token():
    ...
    erc20_token = EvmToken(
        ...
        network=SupportedEvmNetwork.BASE_MINUS_SEPOLIA,
        symbol="TEST",
        name="Test Token",
    )
    assert erc20_token.contract_address == "0x1234567890123456789012345678901234567890"
    assert erc20_token.network == SupportedEvmNetwork.BASE_MINUS_SEPOLIA
    ...
    assert eth_token.network == SupportedEvmNetwork.BASE_MINUS_SEPOLIA
    ...
    assert minimal_token.network == SupportedEvmNetwork.BASE_MINUS_SEPOLIA
