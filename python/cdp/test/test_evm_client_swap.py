...
class TestEvmClientSwap:
    ...
    async def test_create_swap_eth_to_usdc(self):
        ...
        mock_api_clients.evm_swaps.create_evm_swap_without_preload_content = AsyncMock(return_value=mock_response)
