...
class WebhookSubscriptionTarget(BaseModel):
    """Target configuration for webhook delivery."""

    url: str = Field(description="The webhook URL to deliver events to.")
...
class CreateWebhookSubscriptionResult(BaseModel):
    ...
    target: WebhookSubscriptionTarget = Field(
        description="The target configuration for webhook delivery."
    )
