"""Flask middleware tests for ``cdp_x402.middleware.flask``."""
...
from cdp_x402.middleware._common import SETTLEMENT_OVERRIDES_HEADER
...
def test_protected_route_without_payment_returns_402_with_header(app: Flask) -> None:
    ...
    # The header is base64-encoded JSON of the PaymentRequired document.
...
def test_protected_route_with_invalid_payment_returns_402(
    ...
    # Settlement must not happen for invalid payments.
