...
from cdp_x402.core.balance_check import create_balance_check_hook
from cdp_x402.core.credentials import resolve_credentials
from cdp_x402.core.guardrails.types import SpendControls
from cdp_x402.core.wallets.config import WalletConfig, resolve_wallet_config
from cdp_x402.core.wallets.evm_signer import CdpEvmSigner, from_cdp_evm_account
from cdp_x402.core.wallets.scw_signer import CdpSmartWalletSigner, from_cdp_smart_wallet

logger = logging.getLogger(__name__)

if TYPE_CHECKING:
    from cdp_x402.core.guardrails.apply import ResolvedSpendControls
else:
...
class CdpX402ClientConfig:
    ...
    raises :exc:`~cdp_x402.core.balance_check.InsufficientFundsError` early
    ...
    defaults from :data:`~cdp_x402.core.constants.CDP_EVM_RPC_URLS` — only
...
class CdpX402ClientResult:
    ...
    def async_client(self, **httpx_kwargs: Any) -> Any:
        ...
        :func:`~cdp_x402.core.guardrails.wrap_httpx.wrap_httpx_with_payment`
        on :attr:`client`.
        ...
        """
        from cdp_x402.core.guardrails.wrap_httpx import wrap_httpx_with_payment
...
async def _setup_cdp_signers(
    ...
    if config and config.spend_controls:
        try:
            from cdp_x402.core.guardrails.apply import (  # noqa: PLC0415
