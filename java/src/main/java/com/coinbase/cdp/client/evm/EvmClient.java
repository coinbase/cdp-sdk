...
import com.coinbase.cdp.openapi.model.SignEvmHashWithEndUserAccount200Response;
...
public class EvmClient {
   ...
   * @throws ApiException if the API call fails
   */
  public SignEvmHashWithEndUserAccount200Response signHash(
      String address, SignEvmHashRequest request) throws ApiException {
