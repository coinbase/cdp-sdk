...
public class WebhookSubscriptionRequest {
  ...
  public WebhookSubscriptionRequest eventTypes(@jakarta.annotation.Nonnull List<EventType> eventTypes) {
    this.eventTypes = eventTypes;
    return this;
  }

  public WebhookSubscriptionRequest addEventTypesItem(EventType eventTypesItem) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    public WebhookSubscriptionRequest.Builder eventTypes(List<EventType> eventTypes) {
