...
public class RevokeSpendPermissionRequest {
  ...
  public RevokeSpendPermissionRequest walletSecretId(@jakarta.annotation.Nonnull String walletSecretId) {
  ...
  public RevokeSpendPermissionRequest useCdpPaymaster(@jakarta.annotation.Nonnull Boolean useCdpPaymaster) {
