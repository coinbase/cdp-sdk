...
public class EvmAccountsApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public SignEvmHashWithEndUserAccount200Response signEvmHash(String address, String xWalletAuth, String xIdempotencyKey, SignEvmHashRequest signEvmHashRequest) throws ApiException {
    ApiResponse<SignEvmHashWithEndUserAccount200Response> localVarResponse = signEvmHashWithHttpInfo(address, xWalletAuth, xIdempotencyKey, signEvmHashRequest);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<SignEvmHashWithEndUserAccount200Response> signEvmHashWithHttpInfo(String address, String xWalletAuth, String xIdempotencyKey, SignEvmHashRequest signEvmHashRequest) throws ApiException {
