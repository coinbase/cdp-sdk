...
public class Person {
  ...
  public Person address(@jakarta.annotation.Nullable PhysicalAddress address) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    protected Builder(Person instance) {
    ...
    public Person.Builder address(PhysicalAddress address) {
    ...
    /**
    * returns a built Person instance.
    *
