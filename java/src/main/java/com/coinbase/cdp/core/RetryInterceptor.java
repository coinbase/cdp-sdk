...
public class RetryInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (shouldRetry(chain.request(), response.code())) {
    ...
    private static boolean shouldRetry(Request request, int statusCode) {
        boolean idempotentMethod = "GET".equals(request.method())
        ...
        boolean idempotentPost = "POST".equals(request.method())
                && request.header("X-Idempotency-Key") != null;
        return (idempotentMethod || idempotentPost) && (statusCode == 408 || statusCode == 429 || statusCode == 502 || statusCode == 503 || statusCode == 504);
    }
