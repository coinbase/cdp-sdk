...
public class CdpClientApiException extends CdpClientException {
  ...
  public CdpClientApiException(String message, int statusCode, Object body, Response rawResponse) {
    super(message);
    this.statusCode = statusCode;
    this.body = body;
    this.headers = new HashMap<>();
  ...
  public String toString() {
    return "CdpClientApiException{" + "message: " + getMessage() + ", statusCode: " + statusCode + ", body: " + ObjectMappers.stringify(body) + "}";
  }
}
