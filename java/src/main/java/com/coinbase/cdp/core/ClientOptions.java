...
public final class ClientOptions {
  ...
  public static class Builder {
    ...
    /**
     * Override the maximum number of retries. Defaults to 0 retries.
     */
    ...
    public ClientOptions build() {
      ...
      if (this.httpClient != null) {
        ...
        httpClientBuilder.callTimeout(this.timeout.orElse(60), TimeUnit.SECONDS).connectTimeout(0, TimeUnit.SECONDS).writeTimeout(0, TimeUnit.SECONDS).readTimeout(0, TimeUnit.SECONDS);
      }

      httpClientBuilder.addInterceptor(new RetryInterceptor(this.maxRetries));
