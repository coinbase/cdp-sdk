...
@JsonDeserialize(
    builder = ListPaymentMethodsRequest.Builder.class
)
public final class ListPaymentMethodsRequest {
  ...
  private ListPaymentMethodsRequest(Optional<Integer> pageSize, Optional<String> pageToken,
  ...
  public static final class Builder {
    ...
    public ListPaymentMethodsRequest build() {
      return new ListPaymentMethodsRequest(pageSize, pageToken, additionalProperties);
    }
