...
public class WithRawResponsePaymentMethodsClient {
  protected final ClientOptions clientOptions;

  WithRawResponsePaymentMethodsClient(ClientOptions clientOptions) {
   ...
   */
  public CdpClientHttpResponse<ListPaymentMethodsResponse> listPaymentMethods() {
  ...
  public CdpClientHttpResponse<ListPaymentMethodsResponse> listPaymentMethods(
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      try (Response response = client.newCall(okhttpRequest).execute()) {
        ...
        if (response.isSuccessful()) {
          return new CdpClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ListPaymentMethodsResponse.class), response);
        }
        try {
     ...
     */
    public CdpClientHttpResponse<PaymentMethodsPaymentMethod> getPaymentMethod(
    ...
    public CdpClientHttpResponse<PaymentMethodsPaymentMethod> getPaymentMethod(
      ...
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
          ...
          String responseBodyString = responseBody != null ? responseBody.string() : "{}";
          if (response.isSuccessful()) {
            return new CdpClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, PaymentMethodsPaymentMethod.class), response);
          }
          try {
            switch (response.code()) {
              case 400:throw new BadRequestError(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Error.class), response);
