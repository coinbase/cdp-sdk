...
@JsonDeserialize(
    builder = SignSolanaMessageWithEndUserAccountRequest.Builder.class
)
public final class SignSolanaMessageWithEndUserAccountRequest {
  ...
  private SignSolanaMessageWithEndUserAccountRequest(Optional<String> idempotencyKey,
      Optional<String> developerAuth, Optional<String> projectId, String address, String message,
  ...
  /**
   * @return The base64 encoded arbitrary message to sign.
   */
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof SignSolanaMessageWithEndUserAccountRequest && equalTo((SignSolanaMessageWithEndUserAccountRequest) other);
  }
  ...
  private boolean equalTo(SignSolanaMessageWithEndUserAccountRequest other) {
    return idempotencyKey.equals(other.idempotencyKey) && developerAuth.equals(other.developerAuth) && projectId.equals(other.projectId) && address.equals(other.address) && message.equals(other.message) && walletSecretId.equals(other.walletSecretId);
  }

  @java.lang.Override
  public int hashCode() {
    return Objects.hash(this.idempotencyKey, this.developerAuth, this.projectId, this.address, this.message, this.walletSecretId);
  }
  ...
  public interface AddressStage {
     ...
     */
    MessageStage address(@NotNull String address);

    Builder from(SignSolanaMessageWithEndUserAccountRequest other);
  }

  public interface MessageStage {
    /**
     * <p>The base64 encoded arbitrary message to sign.</p>
     */
    _FinalStage message(@NotNull String message);
  }

  public interface _FinalStage {
    SignSolanaMessageWithEndUserAccountRequest build();
  ...
  public static final class Builder implements AddressStage, MessageStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(SignSolanaMessageWithEndUserAccountRequest other) {
    ...
    @java.lang.Override
    @JsonSetter("address")
    public MessageStage address(@NotNull String address) {
    ...
    public SignSolanaMessageWithEndUserAccountRequest build() {
      return new SignSolanaMessageWithEndUserAccountRequest(idempotencyKey, developerAuth, projectId, address, message, walletSecretId, additionalProperties);
    }
