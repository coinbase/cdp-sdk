...
public class WithRawResponsePolicyEngineClient {
  protected final ClientOptions clientOptions;

  WithRawResponsePolicyEngineClient(ClientOptions clientOptions) {
   ...
   */
  public CdpClientHttpResponse<ListPoliciesResponse> listPolicies() {
   ...
   * The response is paginated, and by default, returns 20 policies per page.
   */
  public CdpClientHttpResponse<ListPoliciesResponse> listPolicies(RequestOptions requestOptions) {
   ...
   * The response is paginated, and by default, returns 20 policies per page.
   */
  public CdpClientHttpResponse<ListPoliciesResponse> listPolicies(ListPoliciesRequest request) {
  ...
  public CdpClientHttpResponse<ListPoliciesResponse> listPolicies(ListPoliciesRequest request,
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      try (Response response = client.newCall(okhttpRequest).execute()) {
        ...
        if (response.isSuccessful()) {
          return new CdpClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ListPoliciesResponse.class), response);
        }
        try {
     ...
     */
    public CdpClientHttpResponse<Policy> createPolicy(CreatePolicyRequest request) {
    ...
    public CdpClientHttpResponse<Policy> createPolicy(CreatePolicyRequest request,
      ...
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
          ...
          String responseBodyString = responseBody != null ? responseBody.string() : "{}";
          if (response.isSuccessful()) {
            return new CdpClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Policy.class), response);
          }
          try {
            switch (response.code()) {
       ...
       */
      public CdpClientHttpResponse<Policy> getPolicyById(String policyId) {
      ...
      public CdpClientHttpResponse<Policy> getPolicyById(String policyId,
         ...
         */
        public CdpClientHttpResponse<Policy> updatePolicy(String policyId,
        ...
        public CdpClientHttpResponse<Policy> updatePolicy(String policyId,
           ...
           */
          public CdpClientHttpResponse<Void> deletePolicy(String policyId) {
