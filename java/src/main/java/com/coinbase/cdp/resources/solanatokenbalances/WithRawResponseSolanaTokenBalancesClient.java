...
public class WithRawResponseSolanaTokenBalancesClient {
  protected final ClientOptions clientOptions;

  WithRawResponseSolanaTokenBalancesClient(ClientOptions clientOptions) {
   ...
   */
  public CdpClientHttpResponse<ListSolanaTokenBalancesResponse> listSolanaTokenBalances(
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      try (Response response = client.newCall(okhttpRequest).execute()) {
        ...
        if (response.isSuccessful()) {
          return new CdpClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ListSolanaTokenBalancesResponse.class), response);
        }
        try {
