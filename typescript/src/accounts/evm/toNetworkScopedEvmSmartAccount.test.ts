...
describe("toNetworkScopedEvmSmartAccount", () => {
  ...
  describe("paymasterUrl functionality", () => {
    ...
    describe("base-sepolia network", () => {
      it("should call getBaseNodeRpcUrl for base-sepolia network", async () => {
        await toNetworkScopedEvmSmartAccount(mockApiClient, {
          smartAccount: mockSmartAccount,
          network: "base-sepolia",
          owner: mockOwner,
        ...
        expect(getBaseNodeRpcUrl).toHaveBeenCalledWith("base-sepolia");
      });

      it("should use default paymasterUrl in sendUserOperation for base-sepolia", async () => {
        const account = await toNetworkScopedEvmSmartAccount(mockApiClient, {
          smartAccount: mockSmartAccount,
          network: "base-sepolia",
          owner: mockOwner,
      ...
      it("should use default paymasterUrl in transfer for base-sepolia", async () => {
        const account = await toNetworkScopedEvmSmartAccount(mockApiClient, {
          smartAccount: mockSmartAccount,
          network: "base-sepolia",
          owner: mockOwner,
