...
describe("createDeterministicUuidV4", () => {
  ...
  it("should properly set variant bits", () => {
    ...
    const testCases = [
      { digest: "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef", expectedVariant: "8" },
      { digest: "0123456789abcdef1123456789abcdef0123456789abcdef0123456789abcdef", expectedVariant: "9" },
      { digest: "0123456789abcdef2123456789abcdef0123456789abcdef0123456789abcdef", expectedVariant: "a" },
      { digest: "0123456789abcdef3123456789abcdef0123456789abcdef0123456789abcdef", expectedVariant: "b" },
      { digest: "0123456789abcdef4123456789abcdef0123456789abcdef0123456789abcdef", expectedVariant: "8" },
      { digest: "0123456789abcdef5123456789abcdef0123456789abcdef0123456789abcdef", expectedVariant: "9" },
      { digest: "0123456789abcdef6123456789abcdef0123456789abcdef0123456789abcdef", expectedVariant: "a" },
      { digest: "0123456789abcdef7123456789abcdef0123456789abcdef0123456789abcdef", expectedVariant: "b" },
      { digest: "0123456789abcdef8123456789abcdef0123456789abcdef0123456789abcdef", expectedVariant: "8" },
      { digest: "0123456789abcdef9123456789abcdef0123456789abcdef0123456789abcdef", expectedVariant: "9" },
      { digest: "0123456789abcdefa123456789abcdef0123456789abcdef0123456789abcdef", expectedVariant: "a" },
      { digest: "0123456789abcdefb123456789abcdef0123456789abcdef0123456789abcdef", expectedVariant: "b" },
      { digest: "0123456789abcdefc123456789abcdef0123456789abcdef0123456789abcdef", expectedVariant: "8" },
      { digest: "0123456789abcdefd123456789abcdef0123456789abcdef0123456789abcdef", expectedVariant: "9" },
      { digest: "0123456789abcdefe123456789abcdef0123456789abcdef0123456789abcdef", expectedVariant: "a" },
      { digest: "0123456789abcdeff123456789abcdef0123456789abcdef0123456789abcdef", expectedVariant: "b" },
    ];
  ...
  it("should create permit2 idempotency keys as mentioned in comments", () => {
    ...
    expect(permit2Key).toMatch(/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/);
  });
