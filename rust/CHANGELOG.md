...
- Added delegated signing operations documentation for end users, covering EVM and Solana signing, sending, asset transfers, user operations, EIP-7702 delegation, and delegation revocation
