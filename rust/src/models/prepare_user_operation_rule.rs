...
pub struct PrepareUserOperationRule {
    ...
    pub criteria: Vec<models::PrepareUserOperationCriteriaInner>,
}

impl PrepareUserOperationRule {
    pub fn new(action: Action, operation: Operation, criteria: Vec<models::PrepareUserOperationCriteriaInner>) -> PrepareUserOperationRule {
