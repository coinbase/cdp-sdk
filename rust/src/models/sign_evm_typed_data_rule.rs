...
pub struct SignEvmTypedDataRule {
    ...
    pub criteria: Vec<models::SignEvmTypedDataCriteriaInner>,
}

impl SignEvmTypedDataRule {
    pub fn new(action: Action, operation: Operation, criteria: Vec<models::SignEvmTypedDataCriteriaInner>) -> SignEvmTypedDataRule {
