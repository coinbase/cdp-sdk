...
pub struct SignEvmMessageRule {
    ...
    pub criteria: Vec<models::SignEvmMessageCriteriaInner>,
}

impl SignEvmMessageRule {
    pub fn new(action: Action, operation: Operation, criteria: Vec<models::SignEvmMessageCriteriaInner>) -> SignEvmMessageRule {
        SignEvmMessageRule {
            action,
            operation,
            criteria,
