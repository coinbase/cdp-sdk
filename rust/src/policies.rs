...
use crate::apis::policy_engine_api;
use crate::models::{CreatePolicyRequest, UpdatePolicyRequest};
...
impl<'a> PoliciesApi<'a> {
    ...
    pub async fn list_policies(
        ...
        scope: Option<String>,
    ) -> Result<crate::models::ListPolicies200Response> {
