...
pub struct SignEvmTransactionRule {
    ...
    pub criteria: Vec<models::SignEvmTransactionCriteriaInner>,
}

impl SignEvmTransactionRule {
    pub fn new(action: Action, operation: Operation, criteria: Vec<models::SignEvmTransactionCriteriaInner>) -> SignEvmTransactionRule {
