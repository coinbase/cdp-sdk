...
pub struct SendUserOperationRule {
    ...
    pub criteria: Vec<models::SendUserOperationCriteriaInner>,
}

impl SendUserOperationRule {
    pub fn new(action: Action, operation: Operation, criteria: Vec<models::SendUserOperationCriteriaInner>) -> SendUserOperationRule {
