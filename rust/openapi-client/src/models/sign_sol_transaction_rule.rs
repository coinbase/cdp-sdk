...
pub struct SignSolTransactionRule {
    ...
    pub criteria: Vec<models::SignSolTransactionCriteriaInner>,
}

impl SignSolTransactionRule {
    pub fn new(action: Action, operation: Operation, criteria: Vec<models::SignSolTransactionCriteriaInner>) -> SignSolTransactionRule {
